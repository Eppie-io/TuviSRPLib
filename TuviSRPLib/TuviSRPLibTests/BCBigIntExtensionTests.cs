...
namespace TuviSRPLibTests
{
    public class BCBigIntExtensionTests
    {
        ...
        public void ToLowEndianCorrectConverting(byte[] initialArray, byte[] expectedArray)
        {
        ...
        public void ToLowEndianNBytesCorrectConverting(byte[] initialArray, int N, byte[] expectedArray)
        {
            BigInteger number = new BigInteger(1, initialArray);
        ...
        public void ToLowEndianNBytesWithoutParamCorrectConverting(byte[] initialArray, byte[] expectedArray)
        {
            BigInteger number = new BigInteger(1, initialArray);
        ...
        public void ToBase64CorrectConverting(string base64Number)
        {
